...
//        self.navigationController.navigationBar.translucent = NO;
        ...
        self.navigationController.navigationBar.barTintColor = [UIColor colorWithRed:218.0/255.0 green:67.0/255.0 blue:20.0/255.0 alpha:1.0];
    }
}
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    if (section == 0)
    {
        ...
        view.backgroundColor = [UIColor colorWithRed:218.0/255.0 green:67.0/255.0 blue:20.0/255.0 alpha:1.0];
