...
-(IBAction)contacts:(id)sender{
    ...
    //UITabBarController * tabbar     = (UITabBarController*)[storyboard instantiateViewControllerWithIdentifier:@"TabbarVC"];
    //[self.navigationController pushViewController:tabbar animated:YES];

    
    UIStoryboard *storyboard = [UIStoryboard storyboardWithName:@"Applozic" bundle:[NSBundle bundleForClass:[self class]]];
    ALNewContactsViewController * contacts = (ALNewContactsViewController *)[storyboard instantiateViewControllerWithIdentifier:@"ALNewContactsViewController"];
...
-(IBAction)favourites:(id)sender{
    ...
    UIStoryboard     * storyboard   = [UIStoryboard storyboardWithName:@"Main" bundle:[NSBundle bundleForClass:[self class]]];
    UIViewController * contacts     = [storyboard instantiateViewControllerWithIdentifier:@"FavouriteVC"];
    [self.navigationController pushViewController:contacts animated:YES];
...
-(IBAction)attachments:(id)sender{
    ...
    UIStoryboard     * storyboard   = [UIStoryboard storyboardWithName:@"Main" bundle:[NSBundle bundleForClass:[self class]]];
    UIViewController * contacts     = [storyboard instantiateViewControllerWithIdentifier:@"AttachmentVC"];
    [self.navigationController pushViewController:contacts animated:YES];
}
