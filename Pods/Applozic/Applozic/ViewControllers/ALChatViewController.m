                             ...
                             willShowViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    [navigationController.navigationBar setTitleTextAttributes: @{
                                                                  NSForegroundColorAttributeName:[UIColor colorWithRed:218.0/255.0 green:67.0/255.0 blue:20.0/255.0 alpha:1.0],
         ...
         ABAddressBookRequestAccessWithCompletion(ABAddressBookCreateWithOptions(NULL, nil), ^(bool granted, CFErrorRef error)
         {
             dispatch_async(dispatch_get_main_queue(), ^{
                 ...
                 if (granted)
                 {
                     ...
                     contactPicker.topViewController.navigationController.navigationBar.tintColor    = [UIColor whiteColor];
                     contactPicker.topViewController.navigationController.navigationBar.barTintColor = [UIColor colorWithRed:218.0/255.0 green:67.0/255.0 blue:20.0/255.0 alpha:1.0];
        ...
        [contactStore requestAccessForEntityType:CNEntityTypeContacts completionHandler:^(BOOL granted, NSError * _Nullable error) {
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                if (granted)
                {
                    ...
                    [[UINavigationBar appearance] setBarTintColor:[UIColor colorWithRed:218.0/255.0 green:67.0/255.0 blue:20.0/255.0 alpha:1.0]];
